...
```text
用 xhs-content 做一篇「租房 20 平米，怎么把卧室收出 10㎡ 空地？」的小红书笔记，要完整文案和一张封面。
```
...
```text
查找周末短途露营相关的小红书热门内容，给我一份趋势报告；再做一篇“第一次带狗露营，别把周末过成灾难现场”的笔记和一张封面。
```
...
```text
做一篇小红书笔记：工作第三年想跳槽，到底该裸辞、边找边投，还是先攒够 6 个月生活费？
...
在生成 `publish/cover.png` 前，Skill 会先运行同赛道封面调研。例如“第一次带狗露营”会同时检索 `带狗露营` 和 `宠物露营装备`，查看当前高互动封面的视觉规律，再决定是用照片日记、实物焦点还是清单信息结构。调研参考只留在本地 `cover-research/`，不会被发布、不会作为封面底图、也不应提交到仓库。
...
```text
生成一张无文字的雨天咖啡店工作场景图，并把它做成“自由职业一日记录”小红书封面底图。
```
...
```text
把“第一次一个人去日本：行李、交通、住宿和避坑清单”做成 6 页小红书轮播图。
```
